import { initialise, wrap, addSvg, addDataLabels, addAxisLabel, setupArrowhead, addSource, addAnnotation, createAnnotationSystem } from "../lib/helpers.js";
...
function drawGraphic() {
  ...
  createAnnotationSystem('#toolbar', d3.select('svg'),svg,{xScale:x,yScale:y},margin, chart_width,height)
