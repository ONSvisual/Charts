  ...
  switch (type) {
    ...
    case 'range-horizontal':
      return addAnnotationRangeHorizontal(
        svg, ln.width, y, ln.endY, label, pos.text, pos.inside,
    ...
    case 'direction-arrow':
      return addDirectionArrow(
        svg, arr.direction, pos.anchor, x, y, pos.alignment, label,
        txt.wrapWidth, txt.adjustY, txt.verticalAlign, sty.color, editable
      );
