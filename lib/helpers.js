...
export function createDelaunayOverlay({
  ...
  console.log(margin,'margin from createOverlay')
  ...
  return createCleanupFunction(tooltip, overlay, svgContainer, state);
}
...
function updateTooltip(tooltip, point, config) {
  ...
  tooltip.html(`
    <div style="font-weight: bold; margin-bottom: 8px;">${point.name}</div>
