...
function drawGraphic() {
  ...
  svg
    ...
    .append('text')
    .attr('x', 5)
    .attr('y', y.paddingOuter() * y.bandwidth() + y2.paddingOuter() * y2.bandwidth())
  ...
  svg
    ...
    .append('text')
    .attr('x', 5)
    .attr('y', y.paddingOuter() * y.bandwidth() + y2.paddingOuter() * y2.bandwidth() + y2.bandwidth() + y2.paddingInner() * y2.bandwidth())
    .attr('dy', 3 + y2.bandwidth() / 2)
    .attr('class', 'axis--label')
    .text("Males")
    .attr('text-anchor', 'start')
  ...
  var legenditem = d3.select('#legend')
    ...
    .data(d3.zip(graphic_data.columns.slice(2), config.essential.colour_palette))
    .enter()
    .append('div')
