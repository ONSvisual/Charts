...
function drawGraphic() {
	...
	// This little block of code adds mouseover and mousemove event to the paths

	paths.on('mouseover', () => tooltip.style('visibility', 'visible'))
	.on('mousemove', function (d) {
		const mouse = d3.mouse(this);
		const date = xAxis.invert(mouse[0]);
		const category = d.key;
